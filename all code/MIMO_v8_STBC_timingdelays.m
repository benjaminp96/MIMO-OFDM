% introduce timing delays by offsetting the data by a few symbols
...
% for j = 1:delay_symbols
yn1 = [zeros(delay_symbols,1);X_hat1];
yn2 = [X; zeros(delay_symbols,1)];
% end
