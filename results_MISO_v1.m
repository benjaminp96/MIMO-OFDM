...
%   Version:        Final
%   Changes:        
%   Description:    a 2x1 MISO OFDM System
%                                   
%   Simulates a 2x1 MISO OFDM system. This system includes the
%   Transmitter: 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    title('Two transmitter Single Receiver'); legend('4QAM','16QAM','64QAM');
